...
import com.gmarcolla.demo_park_api.repository.projection.ClienteProjection;
...
import com.gmarcolla.demo_park_api.web.dto.mapper.ClienteMapper;
...
public class ClienteController {
    ...
    @Operation(summary = "Localizar um cliente pelo Id", description = "Recurso para localizar um cliente pelo Id. " +
    ...
    @Operation(summary = "Retornar todos os clientes cadastrados",
    ...
    @Operation(summary = "Recuperar os dados do cliente autenticado",
