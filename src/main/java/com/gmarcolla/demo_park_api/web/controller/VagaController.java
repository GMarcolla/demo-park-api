...
import com.gmarcolla.demo_park_api.service.VagaService;
import com.gmarcolla.demo_park_api.web.dto.UsuarioResponseDto;
import com.gmarcolla.demo_park_api.web.dto.VagaCreateDto;
import com.gmarcolla.demo_park_api.web.dto.VagaResponseDto;
import com.gmarcolla.demo_park_api.web.dto.mapper.VagaMapper;
...
public class VagaController {
    ...
    @Operation(summary = "Localizar uma vaga",
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "409", description = "Vaga não localizada",
                            content = @Content(mediaType = "application/json",
                                    schema = @Schema(implementation = ErrorMessage.class))),
                    @ApiResponse(responseCode = "403", description = "Usuário sem permissão para acessar esse recurso",
                            content = @Content(mediaType = "application/json",
