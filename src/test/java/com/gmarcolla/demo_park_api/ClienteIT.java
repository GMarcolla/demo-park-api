...
public class ClienteIT {
    ...
    public void criarCliente_ComDadosValidos_RetornarClienteComStatus201 (){
        ClienteResponseDto responseBody = testClient
                ...
                .bodyValue(new ClienteCreateDto("Tobias Ferreira", "92932484095"))
                .exchange()
                .expectStatus()
                .isCreated()
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody.getCpf()).isEqualTo("92932484095");
    }
    ...
    public void criarCliente_ComCPFJaCadastrado_RetornarErrorMessageComStatus409 (){
        ErrorMessage responseBody = testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "toby@gmail.com", "123456"))
                .bodyValue(new ClienteCreateDto("Tobias Ferreira", "91305613023"))
                .exchange()
                .expectStatus()
                .isEqualTo(409)
    ...
    public void criarCliente_ComDadosInvalidos_RetornarErrorMessageComStatus422 (){
        ...
        responseBody = testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "toby@gmail.com", "123456"))
                .bodyValue(new ClienteCreateDto("Toby", "913.056.130-23"))
                .exchange()
                .expectStatus()
                .isEqualTo(422)
                .expectBody(ErrorMessage.class)
    ...
    public void buscarCliente_ComDadosDoTokenDoCliente_RetornarClienteComStatus200 (){
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody).isNotNull();
        org.assertj.core.api.Assertions.assertThat(responseBody.getCpf()).isEqualTo("67527423080");
        org.assertj.core.api.Assertions.assertThat(responseBody.getNome()).isEqualTo("Bianca Silva");
        org.assertj.core.api.Assertions.assertThat(responseBody.getId()).isEqualTo(10);
    }

    @Test
    public void buscarCliente_ComDadosDoTokenDoAdmin_RetornarClienteComStatus403 (){
        ErrorMessage responseBody = testClient
                .get()
                .uri("/api/v1/clientes/detalhes")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@gmail.com", "123456"))
